...
public final class ResteasyConstants {
    ...
    public final static String RESTEASY_PROXY_METHOD_PARAMS = "CamelResteasyProxyMethodArgs";
    public final static String RESTEASY_USERNAME = "CamelResteasyLogin";
    public final static String RESTEASY_PASSWORD = "CamelResteasyPassword";
